...
<body>
	<div class="wrapper">
        ...
        <div class="container mt-4 mb-4 logo">
            <a href="{{ route('index') }}">
                <h1 style="font-family: 'Exo 2', sans-serif; color: gray">SNEAKER
            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="product">
                    <ul class="navbar-nav">
						...
						<div class="dropdown">
							<a type="button" class="nav-link dropdown-toggle mt-1" style="font-size:14px;" data-toggle="dropdown">GIÀY</a>
			...
			<div id="footer" class="container">
				<div class="row">
					...
					<div class="col-lg-3">
						...
						<div class="items">
							<p>Cửa hàng giày</p>
							<p><i class="fas fa-map-marker-alt"></i> Chuyên bán các loại giày</p>
						</div>
					</div>
					<div class="col-lg-3">
						<h6>LIÊN HỆ</h6>
